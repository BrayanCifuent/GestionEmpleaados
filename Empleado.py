...
print(mydb)
class Empleado:
    def __init__(self, id_empleado, nombre, direccion, telefono, correo, fecha_inicio, salario, id_tipo, id_departamento):
    ...
    def obtener_info_empleado():
        ...
        # Verificar que el ID de empleado no exista en la base de datos
        ...
        try:
            with mydb.cursor() as miCursor:
                sql = """
                    INSERT INTO empleado (id_empleado, nombre, direccion, telefono, correo, fecha_inicio, salario, id_tipo, id_departamento)
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)
                """
                val = (id_empleado, nombre, direccion, telefono, correo, fecha_inicio, salario, id_tipo, id_departamento)
                miCursor.execute(sql, val)
                mydb.commit()
                print(miCursor.rowcount, "Registro exitoso")
                return Empleado(id_empleado, nombre, direccion, telefono, correo, fecha_inicio, salario, id_tipo, id_departamento)
